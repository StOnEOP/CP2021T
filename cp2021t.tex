...
\\
\>[B]{}\hsindent{73}{}\<[73]%
\>[73]{}\Conid{Product}\to (\Conid{Bin}\;\Conid{Product}\;\Varid{b1}\;\Varid{c1},(\Varid{eval\char95 exp}\;\Varid{a}\;\Varid{b1})\mathbin{*}\Varid{c2}\mathbin{+}\Varid{b2}\mathbin{*}(\Varid{eval\char95 exp}\;\Varid{a}\;\Varid{c1})){}\<[E]%
\\
...
\>[B]{}\hsindent{61}{}\<[61]%
\>[61]{}\Conid{E}{}\<[69]%
\>[69]{}\to (\Conid{Un}\;\Conid{E}\;\Varid{b1},(\Varid{eval\char95 exp}\;\Varid{a}\;\Varid{b1})\mathbin{*}\Varid{b2}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{c}\;\Varid{n}\mathrel{=}\Varid{numA}\;(\mathrm{2}\mathbin{*}(\Varid{s}\;\Varid{n}))\mathbin{\Varid{`div`}}(\Varid{numB}\;(\Varid{s}\;\Varid{n})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{numA}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{numA}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{n}\mathbin{*}(\Varid{numA}\;\Varid{n}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{numB}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{numB}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{n}\mathbin{*}(\Varid{n}\mathbin{-}\mathrm{1})\mathbin{*}(\Varid{numB}\;\Varid{n}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment h 0 = 1}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment h (n+1) = (h n) * (2*(s n))`div`((s (n+1))*(s n)))}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment h 0 = 1}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment h (n+1) = (h n) * (2*(s n))`div`((s (n+1))*(s n)) * (2*(s n)-1)`div`((s n)*(s (n-1)))}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{s}\;\mathrm{0}\mathrel{=}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{s}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\Varid{s}\;\Varid{n})\mathbin{+}\mathrm{1}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{loop}\;(\Varid{c},\Varid{numA},\Varid{numB},\Varid{s})\mathrel{=}(\Varid{numA}\;(\mathrm{2}\mathbin{*}\Varid{s})\mathbin{\Varid{`div`}}\Varid{numB}\;(\Varid{s}),\Varid{numA},\Varid{numB},\Varid{s}\mathbin{+}\mathrm{1}){}\<[E]%
\\
\>[B]{}\Varid{inic}\mathrel{=}(\mathrm{1},\mathrm{1},\mathrm{1},\mathrm{2}){}\<[E]%
\\
\>[B]{}\Varid{prj}\;(\Varid{c},\Varid{numA},\Varid{numB},\Varid{s})\mathrel{=}\Varid{c}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
por forma a que
\begin{hscode}\SaveRestoreHook
