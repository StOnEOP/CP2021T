...
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{Bin}\;\Varid{a}\;\Varid{b}\;\Varid{c})\mathrel{=}i_2\;(i_2\;(i_1\;(\Varid{a},(\Varid{b},\Varid{c})))){}\<[E]%
\\
...
\begin{eqnarray*}
  \xymatrix@C=2cm {
    \ensuremath{\Conid{ExpAr}} \ar\text{\ttfamily \char47{}\char95{}1pc\char47{}\char91{}r\char93{}\char95{}\char45{}\char123{}outExpAr\char125{}~~~~~\char38{}\char124{}X~\char43{}~\char40{}N~\char43{}~\char40{}BinOp~\char92{}times~\char40{}ExpAr~\char92{}times~ExpAr\char41{}~\char43{}~UnOp~\char92{}times~ExpAr\char41{}\char41{}\char124{}~\char92{}ar}/_1pc/[l]_-{inExpAr}
  }
\end{eqnarray*}
--
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{recExpAr}\;\Varid{f}\mathrel{=}\Varid{id}+(\Varid{id}+(\Varid{id}\times(\Varid{f}\times\Varid{f})+\Varid{id}\times\Varid{f})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
---
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{a}\;(i_1\;())\mathrel{=}\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{a}\;(i_2\;(i_1\;\Varid{n}))\mathrel{=}\Varid{n}{}\<[E]%
\\
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{a}\;(i_2\;(i_2\;(i_1\;(\Varid{op},(\Varid{b},\Varid{c})))))\mathrel{=}\mathbf{case}\;\Varid{op}\;\mathbf{of}{}\<[E]%
\\
\>[B]{}\hsindent{61}{}\<[61]%
\>[61]{}\Conid{Sum}{}\<[69]%
\>[69]{}\to \Varid{b}\mathbin{+}\Varid{c}{}\<[E]%
\\
\>[B]{}\hsindent{61}{}\<[61]%
\>[61]{}\Conid{Product}\to \Varid{b}\mathbin{*}\Varid{c}{}\<[E]%
\\
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{a}\;(i_2\;(i_2\;(i_2\;(\Varid{op},\Varid{b}))))\mathrel{=}\mathbf{case}\;\Varid{op}\;\mathbf{of}{}\<[E]%
\\
\>[B]{}\hsindent{55}{}\<[55]%
\>[55]{}\Conid{Negate}{}\<[63]%
\>[63]{}\to \mathbin{-}\Varid{b}{}\<[E]%
\\
\>[B]{}\hsindent{55}{}\<[55]%
\>[55]{}\Conid{E}{}\<[63]%
\>[63]{}\to \Varid{expd}\;(\Varid{b}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{\Conid{ExpAr}}  \ar[d]_-{\ensuremath{\mathrel{=}\Varid{evalExp}\mathrel{=}\cata{\Varid{g\char95 eval\char95 exp}}}} \ar[r]^-{\ensuremath{\Varid{outExpAr}}}
    &\ensuremath{\Conid{X}\mathbin{+}(\Conid{N}\mathbin{+}(\Conid{BinOp}\lambda \Varid{times}\;(\Conid{ExpAr}\lambda \Varid{times}\;\Conid{ExpAr})\mathbin{+}\Conid{UnOp}\lambda \Varid{times}\;\Conid{ExpAr}))} 
        \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{id}\mathbin{+}(\Varid{id}\lambda \Varid{times}\;(\cata{\Varid{g\char95 eval\char95 exp}}\lambda \Varid{times}\;\cata{\cdot }\;\Varid{g\char95 eval\char95 exp})\mathbin{+}\Varid{id}\lambda \Varid{times}\;\cata{\cdot }\;\Varid{g\char95 eval\char95 exp}))}}   \\
    \ensuremath{\Conid{A}}
    &\ensuremath{\Conid{X}\mathbin{+}(\Conid{N}\mathbin{+}(\Conid{BinOp}\lambda \Varid{times}\;(\Conid{A}\lambda \Varid{times}\;\Conid{A})\mathbin{+}\Conid{UnOp}\lambda \Varid{times}\;\Conid{A}))}   \ar[l]^-{\ensuremath{\Varid{g\char95 eval\char95 exp}}}
}
\end{eqnarray*}
---
...
\\
\>[B]{}\mbox{\onelinecomment  Soma}{}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Sum}\;(\Conid{N}\;\mathrm{0})\;\Varid{c})\mathrel{=}\Varid{clean}\;\Varid{c}{}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Sum}\;\Varid{b}\;(\Conid{N}\;\mathrm{0}))\mathrel{=}\Varid{clean}\;\Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Sum}\;\Varid{b}\;\Varid{c})\mathrel{=}i_2\;(i_2\;(i_1\;(\Conid{Sum},(\Varid{b},\Varid{c})))){}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  Produto}{}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Product}\;(\Conid{N}\;\mathrm{1})\;\Varid{c})\mathrel{=}\Varid{clean}\;\Varid{c}{}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{b}\;(\Conid{N}\;\mathrm{1}))\mathrel{=}\Varid{clean}\;\Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Product}\;(\Conid{N}\;\mathrm{0})\;\Varid{c})\mathrel{=}i_2\;(i_1\;\mathrm{0}){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{b}\;(\Conid{N}\;\mathrm{0}))\mathrel{=}i_2\;(i_1\;\mathrm{0}){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{b}\;\Varid{c})\mathrel{=}i_2\;(i_2\;(i_1\;(\Conid{Product},(\Varid{b},\Varid{c})))){}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  Negação}{}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Un}\;\Conid{Negate}\;\Varid{b})\mathrel{=}i_2\;(i_2\;(i_2\;(\Conid{Negate},\Varid{b}))){}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  Expoente}{}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Un}\;\Conid{E}\;(\Conid{N}\;\mathrm{0}))\mathrel{=}i_2\;(i_1\;\mathrm{1}){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Un}\;\Conid{E}\;\Varid{b})\mathrel{=}i_2\;(i_2\;(i_2\;(\Conid{E},\Varid{b}))){}\<[E]%
\\
...
\\
\>[B]{}\Varid{sd\char95 gen}\;(i_2\;(i_1\;\Varid{n}))\mathrel{=}(\Conid{N}\;\Varid{n},\Conid{N}\;\mathrm{0}){}\<[E]%
\\
\>[B]{}\Varid{sd\char95 gen}\;(i_2\;(i_2\;(i_1\;(\Varid{op},((\Varid{b1},\Varid{b2}),(\Varid{c1},\Varid{c2}))))))\mathrel{=}\mathbf{case}\;\Varid{op}\;\mathbf{of}{}\<[E]%
\\
\>[B]{}\hsindent{69}{}\<[69]%
\>[69]{}\Conid{Sum}{}\<[77]%
\>[77]{}\to (\Conid{Bin}\;\Conid{Sum}\;\Varid{b1}\;\Varid{c1},\Conid{Bin}\;\Conid{Sum}\;\Varid{b2}\;\Varid{c2}){}\<[E]%
\\
\>[B]{}\hsindent{69}{}\<[69]%
\>[69]{}\Conid{Product}\to (\Conid{Bin}\;\Conid{Product}\;\Varid{b1}\;\Varid{c1},\Conid{Bin}\;\Conid{Sum}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{b1}\;\Varid{c2})\;(\Conid{Bin}\;\Conid{Product}\;\Varid{b2}\;\Varid{c1})){}\<[E]%
\\
\>[B]{}\Varid{sd\char95 gen}\;(i_2\;(i_2\;(i_2\;(\Varid{op},(\Varid{b1},\Varid{b2})))))\mathrel{=}\mathbf{case}\;\Varid{op}\;\mathbf{of}{}\<[E]%
\\
\>[B]{}\hsindent{53}{}\<[53]%
\>[53]{}\Conid{Negate}{}\<[61]%
\>[61]{}\to (\Conid{Un}\;\Conid{Negate}\;\Varid{b1},\Conid{Un}\;\Conid{Negate}\;\Varid{b2}){}\<[E]%
\\
\>[B]{}\hsindent{53}{}\<[53]%
\>[53]{}\Conid{E}{}\<[61]%
\>[61]{}\to (\Conid{Un}\;\Conid{E}\;\Varid{b1},\Conid{Bin}\;\Conid{Product}\;(\Conid{Un}\;\Conid{E}\;\Varid{b1})\;\Varid{b2}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
---
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{ad\char95 gen}\mathbin{::}\Conid{Floating}\;\Varid{a}\Rightarrow \Varid{a}\to {}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}()+(\Varid{a}+((\Conid{BinOp},((\Conid{ExpAr}\;\Varid{a},\Varid{a}),(\Conid{ExpAr}\;\Varid{a},\Varid{a})))+(\Conid{UnOp},(\Conid{ExpAr}\;\Varid{a},\Varid{a}))))\to (\Conid{ExpAr}\;\Varid{a},\Varid{a}){}\<[E]%
\\
\>[B]{}\Varid{ad\char95 gen}\;\Varid{a}\;(i_1\;())\mathrel{=}(\Conid{X},\mathrm{1}){}\<[E]%
\\
\>[B]{}\Varid{ad\char95 gen}\;\Varid{a}\;(i_2\;(i_1\;\Varid{n}))\mathrel{=}(\Conid{N}\;\Varid{n},\mathrm{0}){}\<[E]%
\\
\>[B]{}\Varid{ad\char95 gen}\;\Varid{a}\;(i_2\;(i_2\;(i_1\;(\Varid{op},((\Varid{b1},\Varid{b2}),(\Varid{c1},\Varid{c2}))))))\mathrel{=}\mathbf{case}\;\Varid{op}\;\mathbf{of}{}\<[E]%
\\
\>[B]{}\hsindent{73}{}\<[73]%
\>[73]{}\Conid{Sum}{}\<[81]%
\>[81]{}\to (\Conid{Bin}\;\Conid{Sum}\;\Varid{b1}\;\Varid{c1},\Varid{b2}\mathbin{+}\Varid{c2}){}\<[E]%
\\
\>[B]{}\hsindent{73}{}\<[73]%
\>[73]{}\Conid{Product}\to (\Conid{Bin}\;\Conid{Product}\;\Varid{b1}\;\Varid{c1},(\Varid{calculaR}\;\Varid{a}\;\Varid{b1})\mathbin{*}\Varid{c2}\mathbin{+}\Varid{b2}\mathbin{*}(\Varid{calculaR}\;\Varid{a}\;\Varid{c1})){}\<[E]%
\\
\>[B]{}\Varid{ad\char95 gen}\;\Varid{a}\;(i_2\;(i_2\;(i_2\;(\Varid{op},(\Varid{b1},\Varid{b2})))))\mathrel{=}\mathbf{case}\;\Varid{op}\;\mathbf{of}{}\<[E]%
\\
\>[B]{}\hsindent{61}{}\<[61]%
\>[61]{}\Conid{Negate}{}\<[69]%
\>[69]{}\to (\Conid{Un}\;\Conid{Negate}\;\Varid{b1},\mathbin{-}\Varid{b2}){}\<[E]%
\\
\>[B]{}\hsindent{61}{}\<[61]%
\>[61]{}\Conid{E}{}\<[69]%
\>[69]{}\to (\Conid{Un}\;\Conid{E}\;\Varid{b1},\Varid{expd}\;(\Varid{calculaR}\;\Varid{a}\;\Varid{b1})\mathbin{*}\Varid{b2}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calculaR}\mathbin{::}\Conid{Floating}\;\Varid{a}\Rightarrow \Varid{a}\to \Conid{ExpAr}\;\Varid{a}\to \Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{calculaR}\;\Varid{a}\;\Conid{X}\mathrel{=}\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{calculaR}\;\Varid{a}\;(\Conid{N}\;\Varid{b})\mathrel{=}\Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{calculaR}\;\Varid{a}\;(\Conid{Bin}\;\Varid{op}\;\Varid{b}\;\Varid{c})\mathrel{=}\mathbf{case}\;\Varid{op}\;\mathbf{of}{}\<[E]%
\\
\>[B]{}\hsindent{37}{}\<[37]%
\>[37]{}\Conid{Sum}{}\<[45]%
\>[45]{}\to (\Varid{calculaR}\;\Varid{a}\;\Varid{b})\mathbin{+}(\Varid{calculaR}\;\Varid{a}\;\Varid{c}){}\<[E]%
\\
\>[B]{}\hsindent{37}{}\<[37]%
\>[37]{}\Conid{Product}\to (\Varid{calculaR}\;\Varid{a}\;\Varid{b})\mathbin{*}(\Varid{calculaR}\;\Varid{a}\;\Varid{c}){}\<[E]%
\\
\>[B]{}\Varid{calculaR}\;\Varid{a}\;(\Conid{Un}\;\Varid{op}\;\Varid{b})\mathrel{=}\mathbf{case}\;\Varid{op}\;\mathbf{of}{}\<[E]%
\\
\>[B]{}\hsindent{35}{}\<[35]%
\>[35]{}\Conid{Negate}{}\<[43]%
\>[43]{}\to \mathbin{-}(\Varid{calculaR}\;\Varid{a}\;\Varid{b}){}\<[E]%
\\
\>[B]{}\hsindent{35}{}\<[35]%
\>[35]{}\Conid{E}{}\<[43]%
\>[43]{}\to \Varid{expd}\;(\Varid{calculaR}\;\Varid{a}\;\Varid{b}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{h}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{h}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(((\mathrm{2}\mathbin{*}(\Varid{s}\;\Varid{n}))\mathbin{*}((\mathrm{2}\mathbin{*}(\Varid{s}\;\Varid{n}))\mathbin{-}\mathrm{1}))\mathbin{*}(\Varid{h}\;\Varid{n}))\mathbin{\Varid{`div`}}((\Varid{p}\;\Varid{n})\mathbin{*}(\Varid{s}\;\Varid{n})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{s}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{s}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\Varid{s}\;\Varid{n})\mathbin{+}\mathrm{1}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{p}\;\mathrm{0}\mathrel{=}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{p}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\Varid{p}\;\Varid{n})\mathbin{+}\mathrm{1}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{loop}\;(\Varid{h},\Varid{s},\Varid{p})\mathrel{=}((((\mathrm{2}\mathbin{*}\Varid{s})\mathbin{*}((\mathrm{2}\mathbin{*}\Varid{s})\mathbin{-}\mathrm{1}))\mathbin{*}\Varid{h})\mathbin{\Varid{`div`}}(\Varid{p}\mathbin{*}\Varid{s}),\Varid{s}\mathbin{+}\mathrm{1},\Varid{p}\mathbin{+}\mathrm{1}){}\<[E]%
\\
\>[B]{}\Varid{inic}\mathrel{=}(\mathrm{1},\mathrm{1},\mathrm{2}){}\<[E]%
\\
\>[B]{}\Varid{prj}\;(\Varid{h},\Varid{s},\Varid{p})\mathrel{=}\Varid{h}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
por forma a que
\begin{hscode}\SaveRestoreHook
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{avg}\mathrel{=}\p1\comp \Varid{avgAUX}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{avgB}\mathrel{=}\Varid{cataList}\;\alt{\conj{\conj{\Varid{zero}}{\Varid{zero}}}{\Varid{zero}}}{\conj{\conj{\Varid{add}\comp (\Varid{id}\times(\p1\comp \p1))}{\succ \comp \p2\comp \p1\comp \p2}}{\succ \comp \p2\comp \p2}}{}\<[E]%
\\
\>[B]{}\Varid{divI}\;(\Varid{a},\Varid{b})\mathrel{=}(\Varid{fromIntegral}\;\Varid{a})\mathbin{/}(\Varid{fromIntegral}\;\Varid{b}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{avgAUX}\mathrel{=}(\Varid{divI}\times\Varid{id})\comp \Varid{avgB}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\subsubsection*{2.}
